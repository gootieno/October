...
function restoreTheme() {
  // Your code here
  //   const themeName = document.cookie;
  //   console.log("theme name ", themeName);
  //   const keyVal = themeName.split("=");
  //   const cookieVal = keyVal[1];
  //   if (cookieVal) setTheme(cookieVal);
...
function storeName(displayName) {
  // Your code here
  document.cookie = `displayName=${displayName};max-age=25`;
}
