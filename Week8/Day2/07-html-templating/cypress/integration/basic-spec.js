describe("Phase 1: GET /dogs", function () {
    ...
    before(function () {
        cy.visit("localhost:5050/dogs", {failOnStatusCode: false});
    });
...
describe("Phase 3: GET /dogs/:dogId", function () {
    ...
    it("displays the name and age of the dog identified by the :dogId route parameter.", function () {
        cy.visit("localhost:5050/dogs/1", {failOnStatusCode: false});
        cy.get("body h1")
            .should("contain", "Fido")
        cy.get("body div")
            .should("contain", "Age: 2")

        cy.visit("localhost:5050/dogs/2", {failOnStatusCode: false});
        cy.get("body h1")
